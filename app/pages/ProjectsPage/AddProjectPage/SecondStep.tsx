    ...
    <>
      ...
      <div className="project__form-wrapper">
        ...
        <FormControl>
          ...
          />
          <FormErrorMessage>
            {errors?.total_tower?.message && errors?.total_tower?.message}
          </FormErrorMessage>
        </FormControl>
        <FormControl>
          <Input placeholder="Towers" register={{ ...register("towers") }} />
          <FormErrorMessage>
        ...
        <FormControl>
          ...
          />
          <FormErrorMessage>
            {errors?.ProjectArea?.message && errors?.ProjectArea?.message}
          </FormErrorMessage>
        </FormControl>
        <FormControl>
          <Input placeholder="RERA ID" register={{ ...register("RERAID") }} />
          <FormErrorMessage>
            {errors?.RERAID?.message && errors?.RERAID?.message}
          </FormErrorMessage>
        </FormControl>
        <FormControl>
          <Input placeholder="Type" register={{ ...register("type") }} />
          <FormErrorMessage>
        ...
        <FormControl>
          ...
          />
          <FormErrorMessage>
            {errors?.LocationLink?.message && errors?.LocationLink?.message}
          </FormErrorMessage>
        </FormControl>
        ...
        <button onClick={() => setStep(3)} className="btn" type="button">
          Continue
        </button>
      </div>
    </>
