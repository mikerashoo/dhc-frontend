...
const LeadsUsersPage = () => {
    ...
    return (
        <section className="section">
            <div className="section__header flex flex-wrap md:flex-nowrap gap-4">
                <h2>Users Leads</h2>
                <div className="section__header-select w-full">
                    <Select
                        classNamePrefix="default w-full"
                        options={options}
                ...
                {/* <div className="section__header-right"></div> */}
            </div>
